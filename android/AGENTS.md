...
Tokens: `library`, `queue` (download manager), `settings`, `notifications`, `aisettings`, `updates`, `followupdates`, `reader`, `details`, `addstory`.
