 ...
 * into capped plain text for AI prompts. Shared by the description and cover engines so every AI
...
internal object AiContextChapters {
    suspend fun read(
        ...
        AiDescriptionPlanning.selectContextChapters(story).mapNotNull { index ->
