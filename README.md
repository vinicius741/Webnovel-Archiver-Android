...
- **AI Features** — Per-novel AI-generated synopses and cover art through the user's own OpenRouter key: per-task model pickers (cheap text default; `x-ai/grok-imagine-image-2.0` for covers), preview-then-apply drafts, and replaceable-but-revertible covers (the source cover URL is never modified; generated covers show across the app and embed into EPUB exports).
