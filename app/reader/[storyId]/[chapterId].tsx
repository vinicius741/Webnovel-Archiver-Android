...
export default function ReaderScreen() {
  ...
  useEffect(() => {
    currentChapterTitleRef.current = chapter
      ? sanitizeTitle(chapter.title)
      : "Reading";
  }, [chapter]);
  ...
  useEffect(() => {
    ...
    if (
      ...
      const timer = setTimeout(() => {
        ...
        toggleSpeech(
          ttsChunks,
          chapter ? sanitizeTitle(chapter.title) : "Reading",
          {
            storyId,
            chapterId: decodedChapterId,
            chapterTitle: chapter ? sanitizeTitle(chapter.title) : "Reading",
    ...
    () => () => (
      <View style={{ flexDirection: "row" }}>
        <IconButton
          ...
          iconColor={
            isSpeakingRef.current ? themeColorsRef.current.error : undefined
          }
        ...
        <IconButton
          ...
          iconColor={
            isLastReadRef.current ? themeColorsRef.current.primary : undefined
          }
          onPress={markAsRead}
        />
      </View>
