...
describe("useDownloadProgress", () => {
    ...
    const mockJobs: DownloadJob[] = [
      {
        ...
        storyTitle: "Test",
        chapterIndex: 0,
        chapter: { id: "c1", title: "Chapter 1", url: "http://c1" },
        status: "completed",
        addedAt: 0,
        retryCount: 0,
      },
      {
        ...
        storyTitle: "Test",
        chapterIndex: 1,
        chapter: { id: "c2", title: "Chapter 2", url: "http://c2" },
        status: "downloading",
        addedAt: 0,
        retryCount: 0,
      },
      {
        ...
        storyTitle: "Test",
        chapterIndex: 2,
        chapter: { id: "c3", title: "Chapter 3", url: "http://c3" },
        status: "pending",
        addedAt: 0,
        retryCount: 0,
      },
  ...
  it("should unsubscribe from events on unmount", () => {
    ...
    expect(downloadManager.off).toHaveBeenCalledWith(
      "queue-updated",
      expect.any(Function),
    );
    expect(downloadManager.off).toHaveBeenCalledWith(
  ...
  it("should handle download progress calculation correctly", () => {
    const mockJobs: DownloadJob[] = [
      ...
      },
      {
        ...
        storyTitle: "Test",
        chapterIndex: 3,
        chapter: { id: "c4", title: "Chapter 4", url: "http://c4" },
        status: "downloading",
        addedAt: 0,
        retryCount: 0,
      },
  ...
  it("should show correct chapter title in status when downloading", () => {
    const mockJobs: DownloadJob[] = [
      {
        ...
        storyTitle: "Test",
        chapterIndex: 0,
        chapter: { id: "c1", title: "Active Chapter Title", url: "http://c1" },
        status: "downloading",
        addedAt: 0,
        retryCount: 0,
      },
    ...
    expect(result.current.status).toBe(
      "Downloading: Active Chapter Title (0/1)",
    );
  });
});
