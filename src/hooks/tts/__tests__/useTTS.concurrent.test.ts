...
import { TTS_STATE_EVENTS } from "../../../services/tts/TTSStateManager";
...
jest.mock("../../../services/download/NotifeeTypes", () => ({
  loadNotifee: jest.fn(() => null),
}));

jest.mock("../../../services/tts/TtsMediaSessionService", () => ({
...
describe("useTTS - Concurrent Operations", () => {
  beforeEach(async () => {
    ...
    const { ttsStateManager } = require("../../../services/tts/TTSStateManager");
  ...
  it("should handle rapid play/pause toggles through native playback", async () => {
    ...
    const { ttsMediaSessionService } = require("../../../services/tts/TtsMediaSessionService");
