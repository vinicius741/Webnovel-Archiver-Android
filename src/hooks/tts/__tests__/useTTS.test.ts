...
import {
  ttsStateManager,
  TTS_STATE_EVENTS,
} from "../../../services/tts/TTSStateManager";
import * as Speech from "expo-speech";

jest.mock("../../../services/tts/TTSStateManager");
...
describe("useTTS", () => {
  ...
  beforeEach(() => {
    ...
    (ttsStateManager.setOnFinishCallback as jest.Mock).mockReturnValue(
      undefined,
    );
  });
  ...
  it("should set onFinish callback", () => {
    ...
    expect(ttsStateManager.setOnFinishCallback).toHaveBeenCalledWith(
      expect.any(Function),
    );
  });
