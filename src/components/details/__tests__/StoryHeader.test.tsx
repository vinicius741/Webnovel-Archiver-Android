...
jest.mock("../../common/ImageViewer/index", () => {
...
describe("StoryHeader", () => {
  ...
  it("should not render cover image when coverUrl is undefined", () => {
    const props = {
      ...defaultProps,
      story: { ...defaultProps.story, coverUrl: undefined },
    };
  ...
  it("should not render score when not provided", () => {
    const props = {
      ...defaultProps,
      story: { ...defaultProps.story, score: undefined },
    };
  ...
  it("should handle long title", () => {
    const longTitle =
      "This is a very long title that might need to be truncated in the UI";
    const props = {
      ...defaultProps,
      story: { ...defaultProps.story, title: longTitle },
    };
  ...
  it("should handle long author name", () => {
    const longAuthor =
      "This is a very long author name that might need to be truncated";
    const props = {
      ...defaultProps,
      story: { ...defaultProps.story, author: longAuthor },
    };
    const { getByText } = renderWithTheme(<StoryHeader {...props} />);
