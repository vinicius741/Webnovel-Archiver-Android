      ...
      return (
        <View testID="sort-button-container">
          ...
          {visible && (
            <View testID="menu">
              <TouchableOpacity
                testID="Default (Smart)"
                onPress={() => handleSelect("default")}
              >
                <Text>Default (Smart)</Text>
              </TouchableOpacity>
              <TouchableOpacity
                testID="Title"
              ...
              <View testID="divider" />
              <TouchableOpacity
                testID={sortDirection === "asc" ? "Ascending" : "Descending"}
...
describe("SortButton", () => {
  ...
  it("should show ascending icon when direction is asc", () => {
    const { getByTestId } = render(
      <SortButton {...defaultProps} sortDirection="asc" />,
    );
  ...
  it("should show descending icon when direction is desc", () => {
    const { getByTestId } = render(
      <SortButton {...defaultProps} sortDirection="desc" />,
    );
