...
jest.mock("../../download/ForegroundServiceCoordinator", () => ({
...
describe("TTSNotificationService", () => {
  ...
  it("should start TTS service", async () => {
    ...
    const { setTtsState } = require("../../download/ForegroundServiceCoordinator");
  ...
  it("should stop TTS service", async () => {
    const { ttsNotificationService } = require("../TTSNotificationService");
    const { clearTtsState } = require("../../download/ForegroundServiceCoordinator");
