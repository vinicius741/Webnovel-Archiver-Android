...
describe("EpubMetadataGenerator", () => {
  ...
  describe("XML Escaping", () => {
    ...
    it("should escape ampersand", () => {
      expect(EpubMetadataGenerator.escapeXml("Tom & Jerry")).toBe(
        "Tom &amp; Jerry",
      );
    });
    ...
    it("should escape double quote", () => {
      expect(EpubMetadataGenerator.escapeXml('"Hello"')).toBe(
        "&quot;Hello&quot;",
      );
    });
    ...
    it("should handle string without special characters", () => {
      expect(EpubMetadataGenerator.escapeXml("Normal Text")).toBe(
        "Normal Text",
      );
    });
  });
  ...
  describe("Filename Sanitization", () => {
    it("should sanitize special characters", () => {
      const sanitized =
        EpubMetadataGenerator.sanitizeFilename("Test: Chapter 1!");
  ...
  describe("OPF Generation", () => {
    it("should generate valid OPF XML", () => {
      ...
      expect(opf).toContain(
        '<dc:identifier id="BookId">test-uid</dc:identifier>',
      );
    });
