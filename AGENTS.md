...
- Repo agent skills live under `.agents/skills/` (`build-and-install-apk`, `dev-launch-screen`, `emulator-qa`, `perf-suite`, `restore-library-backup`). Prefer those skills over re-deriving build/install/QA steps.
